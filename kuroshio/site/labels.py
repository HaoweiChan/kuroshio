...
LABELS: dict[str, dict[str, str]] = {
    "en": {
        ...
        "no_report": "(no report)",
        # --- report page (the tabbed per-report layout) ---
        "synthesis": "Synthesis",
        "committee_rating": "Committee rating",
        "executive_thesis": "Executive thesis",
        "no_summary": "This report carries no executive summary.",
        "coverage": "Coverage",
        "included": "included",
        "not_included": "not included",
        "final_posture": "Final posture",
        "reference_close": "Reference close",
        "rr_from_close": "R:R from close",
        "sizing_dates": "Sizing & dates",
        "rating_date": "rating date",
        "analyst_lenses": "Analyst lenses",
        "lenses_lede": "One card per analyst file, split into blocks at each section heading.",
        "lens": "Lens",
        "research_desk": "Research desk",
        "bull_vs_bear": "Bull vs bear",
        "risk_committee": "Risk committee",
        "risk_postures": "Risk postures",
        "decision_trail": "Decision trail",
        "decision_lede": "Research plan, then the trader, then the final call.",
        "stage": "Stage",
        ...
        "tab_raw": "Raw report",
        "empty_head": "Nothing to show here",
        "empty_lede": "This report tree carries no file for this tab — only the raw report.",
        "role_market": "Market",
        "role_sentiment": "Sentiment",
        "role_news": "News",
        "role_fundamentals": "Fundamentals",
        "role_bull": "Bull",
        "role_bear": "Bear",
        "role_manager": "Research manager",
        "role_trader": "Trader",
    ...
    "zh": {
        ...
        "no_report": "（無報告）",
        "synthesis": "綜合",
        "committee_rating": "委員會評級",
        "executive_thesis": "執行論點",
        "no_summary": "這份報告沒有寫執行論點。",
        "coverage": "涵蓋",
        "included": "已納入",
        "not_included": "未納入",
        "final_posture": "最終立場",
        "reference_close": "參考收盤",
        "rr_from_close": "從收盤算 R:R",
        "sizing_dates": "倉位與日期",
        "rating_date": "評級日期",
        "analyst_lenses": "分析師視角",
        "lenses_lede": "每個分析師檔案一張卡片，依章節標題切成區塊。",
        "lens": "視角",
        "research_desk": "研究台",
        "bull_vs_bear": "多空辯論",
        "risk_committee": "風控委員會",
        "risk_postures": "風險立場",
        "decision_trail": "決策歷程",
        "decision_lede": "研究計畫、交易員、最後拍板。",
        "stage": "階段",
        "research_plan": "研究計畫",
        "trader_decision": "交易員決定",
        "final_decision": "最終決定",
        "tab_overview": "總覽",
        "tab_research": "研究",
        "tab_debates": "辯論",
        ...
        "tab_raw": "原始報告",
        "empty_head": "這裡沒有東西",
        "empty_lede": "這個報告目錄沒有這一頁要的檔案，只有原始報告。",
        "role_market": "市場",
        "role_sentiment": "情緒",
        "role_news": "新聞",
        "role_fundamentals": "基本面",
        "role_bull": "多方",
        "role_bear": "空方",
        "role_manager": "研究主管",
        "role_trader": "交易員",
