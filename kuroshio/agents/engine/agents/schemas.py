...
class PortfolioDecision(BaseModel):
    ...
    price_target: float | None = Field(
        default=None,
        description=(
            "Target price in the instrument's quote currency, as a bare number "
            "(e.g. 1100, not '$1,100' or '1100 USD'). Populate this whenever your "
            "executive summary or thesis names or implies an upside target; leave "
            "null only if you deliberately set no target."
        ),
    )
    stop_loss: float | None = Field(
        default=None,
        description=(
            "Protective stop-loss / invalidation price in the instrument's quote "
            "currency, as a bare number (e.g. 883, not '$883' or '883 USD'). "
            "Populate this whenever your executive summary or thesis names or "
            "implies a stop or invalidation level; leave null only if you "
            "deliberately set no stop."
        ),
    )
