# TradingAgents/graph/setup_us.py
...
class GraphSetupUS:
    """Standard US graph setup, preserving the historical sequential flow."""
    ...
    def setup_graph(
        ...
        portfolio_manager_node = create_portfolio_manager_us(self.deep_thinking_llm)
