...
header (see :func:`kuroshio.agents.engine.agents.schemas.render_pm_decision`).  The
deterministic heuristic in :mod:`kuroshio.agents.engine.agents.utils.rating` is more
